...
<template>
  <li class="relative">
    <div
      v-if="isPremium"
      class="absolute z-10 inset-0 flex flex-col justify-center items-center p-12 cursor-not-allowed"
    >
      <div
        class="w-12 h-12 bg-brand-blue rounded-full p-3 border-2 border-color-white"
      >
        <img
      ...
      <p class="font-semibold text-xl text-center">
        Voor het bekijken van deze woning heb je een account nodig
      </p>
    </div>
    ...
    >
      <div class="flex flex-col gap-6 w-full p-6 bg-white rounded-b-xl">
        ...
        <div class="flex flex-col gap-1">
          <span class="text-lg font-semibold text-brand-dark-gray">{{
            props.item.street
          }}</span>
        ...
        <div class="flex justify-between">
          ...
          <button
            class="text-sm font-semibold text-brand-blue cursor-not-allowed"
          >
            Meer zien
          </button>
        </div>
